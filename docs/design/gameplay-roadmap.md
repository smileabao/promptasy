...
- [ ] **P25b0 · 小景零件貼地（站長 2026-09-03 實玩發現）**（S–M）— 小景是「成組」擺的：整組落在**組中心**的地面高度上、組內用局部位移，可是地面會起伏，所以離中心越遠的零件越容易浮起來或沉下去。**實測 160 件零件裡 54 件（34%）偏差 > 0.25 公尺、33 組小景裡 27 組（82%）中招**；最糟浮空 1.20 m、埋地 0.95 m；1.0 m 以上 3 件、0.6–1.0 m 22 件。修法照 P11 對「母題」那一層做過的：**逐件取樣地面**——但要保留兩種例外（`FLOAT_MIN` 1.6 m 以上是刻意飄著的；疊在別的零件上的維持疊著），而且「靠著／斜倚」的姿態不能硬貼地。順手加一條稽核（現在沒有任何斷言在管這件事，所以它會一直退化）。
